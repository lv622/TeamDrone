...
import com.viasofts.mygcs.utils.Utils;
...
public class DroidPlannerPrefs {
    ...
    private static com.viasofts.mygcs.utils.prefs.DroidPlannerPrefs instance;

    public static synchronized com.viasofts.mygcs.utils.prefs.DroidPlannerPrefs getInstance(Context context) {
        if (instance == null) {
            instance = new com.viasofts.mygcs.utils.prefs.DroidPlannerPrefs(context);
        }
